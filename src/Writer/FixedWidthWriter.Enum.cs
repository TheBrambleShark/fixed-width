...
{
    internal sealed partial class FixedWidthWriter
    {
        private sealed class EnumSerializer(FixedWidthWriter writer) : ITypeSerializer
        {
            ...
            [DoesNotReturn]
            private static void ThrowInvalidEnum([CallerMemberName] string memberName = "<error>")
            {
